DATA_PATH=/mnt/data/sata/zxj/data/LLaVA-Video-178K/0_30_s_academic_v0_1/0_30_s_academic_v0_1_cap_processed.json #pretrain annotation file path
FINETUNE_DATA_PATH=/home/ai/data/llava/dataset/text_files/llava_v1_5_mix665k.json #finetune annotation file path
IMAGE_PATH=/mnt/data/sata/zxj/data/LLaVA-Video-178K/0_30_s_academic_v0_1 #pretrain image dir
FINETUNE_IMAGE_PATH=/home/ai/data/llava/dataset #finetune image dir

LLM_VERSION="/mnt/data/sata/zxj/checkpoints/SmolLM-360M" # llm path in huggingface
